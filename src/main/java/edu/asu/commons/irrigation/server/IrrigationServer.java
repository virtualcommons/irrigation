 ...
 * @version $Revision$
 */
public class IrrigationServer extends
		AbstractExperiment<ServerConfiguration, RoundConfiguration> {
	...
	private class IrrigationServerStateMachine implements StateMachine {
		...
		private void advanceToNextRound() {
			...
			RoundConfiguration nextRoundConfiguration = getConfiguration()
					.nextRound();
			...
			transmit(new RegistrationEvent(getFacilitatorId(),
					nextRoundConfiguration));
		...
		public void execute(Dispatcher dispatcher) {
			...
			case WAITING:
				getLogger().info(
						"Waiting for facilitator signal to start next round.");
