	    ...
	    if (enableInstructionButton == null) {
	        ...
	        enableInstructionButton.addActionListener(new ActionListener() {
	            public void actionPerformed(ActionEvent event) {
	            	...
	            	facilitator.transmit(new InstructionEnableRequest(facilitator.getIdentifier()));
	            }
	        });
	    }
	        ...
	        beginChatButton.addActionListener(new ActionListener() {
	            public void actionPerformed(ActionEvent event) {
	            	...
	            	if(facilitator.getCurrentRoundConfiguration().isChatEnabledBeforeRound()){
	            		facilitator.transmit(new BeginCommunicationRequest(facilitator.getIdentifier()));
	            	}
	            	else
	            	facilitator.transmit(new DisplaySubmitTokenRequest(facilitator.getIdentifier()));
	            }
	        });
	    }
