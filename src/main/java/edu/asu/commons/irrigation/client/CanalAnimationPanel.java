...
public class CanalAnimationPanel extends JPanel {
        ...
        if (enableBallAnimation) {
            ...
            for (int i = 0; i < BALLCOUNT; i++) {
                ...
                if ((balls[i].getPosition() == 1) || (balls[i].getPosition() == 2) || (balls[i].getPosition() == 3)
                    ...
                    if (!((!gate[balls[i].getPosition() - 1].isOpen()) && balls[i].getY() >= (gate[balls[i].getPosition() - 1].getY() + gate[balls[i]
        ...
        switch (balls[i].getPosition()) {
            ...
            case 0:
                ...
                // still in server
                    ...
                    setBounds(i);
                    if (balls[i].x <= balls[i].xUpperBound || balls[i].x >= balls[i].xUpperBound - balls[i].getBallSize()) {
            ...
            case 1: /*
                     * if(gate[0].isOpenGate() && (balls[i].x >= 400 && balls[i].x <= 420) && (balls[i].y >= 80 &&
                     * balls[i].y <= 100)){
                     */
                if (gate[0].isOpen() && (balls[i].x >= gate[0].getOpeningsX() && balls[i].x <= (gate[0].getOpeningsX() + 20))
                     ...
                     * +" X Lower"+balls[i].xLowerBound+" X Upper"+balls[i].xBOUNDSUPPER);
                     */
                    /*
            ...
            case 2:
                if (gate[1].isOpen() && (balls[i].x >= gate[1].getOpeningsX() && balls[i].x <= (gate[1].getOpeningsX() + 20))
                        && (balls[i].y >= 80 && balls[i].y <= 100)) {
            ...
            case 3:
                if (gate[2].isOpen() && (balls[i].x >= gate[2].getOpeningsX() && balls[i].x <= (gate[2].getOpeningsX() + 20))
                        && (balls[i].y >= 80 && balls[i].y <= 100)) {
            ...
            case 4:
                if (gate[3].isOpen() && (balls[i].x >= gate[3].getOpeningsX() && balls[i].x <= (gate[3].getOpeningsX() + 20))
                        && (balls[i].y >= 80 && balls[i].y <= 100)) {
            ...
            case 5:
                if (gate[4].isOpen() && (balls[i].x >= gate[4].getOpeningsX() && balls[i].x <= (gate[4].getOpeningsX() + 20))
                        && (balls[i].y >= 80 && balls[i].y <= 100)) {
    ...
    private void setBounds(int ballIndex) {
        ...
        if (balls[ballIndex].getPosition() == 0) {
            balls[ballIndex].xUpperBound = 100;
            balls[ballIndex].xLowerBound = 0;
            balls[ballIndex].yUpperBound = 100;
            ...
            // the ball is in one of the openings
                ...
                balls[ballIndex].xUpperBound = gate[balls[ballIndex].getPosition() - 7].getOpeningsX()
                        + gate[balls[ballIndex].getPosition() - 7].getGateWidth();
                balls[ballIndex].xLowerBound = gate[balls[ballIndex].getPosition() - 7].getOpeningsX();
                balls[ballIndex].yUpperBound = gate[balls[ballIndex].getPosition() - 7].getOpeningsY()
                        + gate[balls[ballIndex].getPosition() - 7].getOpeningsHeight();
